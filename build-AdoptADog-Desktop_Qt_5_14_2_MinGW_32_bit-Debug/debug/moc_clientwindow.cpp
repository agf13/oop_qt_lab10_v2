...
#include <memory>
#include "../../a89-agf13-master/clientwindow.h"
...
QT_MOC_LITERAL(1, 13, 11), // "filterEvent"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11), // "filterStore"
QT_MOC_LITERAL(4, 38, 5) // "adopt"

    },
    "ClientWindow\0filterEvent\0\0filterStore\0"
    "adopt"
};
...
void ClientWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->filterEvent(); break;
        case 1: _t->filterStore(); break;
        case 2: _t->adopt(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientWindow::filterEvent)) {
                *result = 0;
                return;
            }
        }
